...
- Windows: an issue whose primary field is null but carries an alias (e.g. `"title": null, "issueTitle": …`) is now read like macOS reads it, instead of failing the whole extraction.
